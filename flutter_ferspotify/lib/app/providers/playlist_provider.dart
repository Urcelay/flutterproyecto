...
class PlaylistProvider {
  ...
  /// Endpoint: POST /api/lista/create
  static Future<PlaylistResponse?> createPlaylist(
    String token,
    String name,
    bool isPublic,
  ) async {
    ...
    print(
      "📤 [PlaylistProvider] Body enviado: {name: $name, is_public: $isPublic}",
    );
    ...
    try {
      ...
      print(
        "🟡 [PlaylistProvider] Código de respuesta: ${response.statusCode}",
      );
      ...
      if (response.statusCode == 200) {
        ...
        print(
          "🔴 [PlaylistProvider] Error en createPlaylist: ${response.body}",
        );
        return null;
      }
    } catch (e) {
  ...
  /// Endpoint: GET /api/lista/{user_id}
  ...
  /// Endpoint: PUT /api/lista/{id}/edit
  static Future<PlaylistResponse?> updatePlaylist(
      String token,
      int playlistId,
      String name,
       isPublic
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        print("🟢 [PlaylistProvider] Playlist editada correctamente.");
        return PlaylistResponse.fromJson(data);
      } else {
  ...
  /// Requiere autenticación.
  /// Devuelve un [SimpleResponse] con el mensaje de éxito o error.
  /// Endpoint: DELETE /api/lista/{id}/delete
  static Future<SimpleResponse?> deletePlaylist(
    String token,
    int playlistId,
  ) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return SimpleResponse.fromJson(data);
      } else {
        print(
          "🔴 [PlaylistProvider] Error en deletePlaylist: ${response.body}",
        );
        return null;
      }
    } catch (e) {
