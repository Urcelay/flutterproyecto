...
class AuthProvider {
  ...
  static Future<AuthResponseModel?> login(String email, String password) async {
    ...
    print(
      "📤 [AuthProvider] Body enviado: {email: $email, password: $password}",
    );
  ...
  static Future<AuthResponseModel?> register(
    ...
    print(
      "📤 [AuthProvider] Body enviado: {name: $name, email: $email, password: $password}",
    );
  ...
  static Future<SimpleResponse?> logout(String token) async {
